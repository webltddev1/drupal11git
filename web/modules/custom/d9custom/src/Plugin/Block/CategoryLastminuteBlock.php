...
/**
 * Category Lastminute Block
 *
 * @Block(
 *   id = "catslastminute_block",
 *   admin_label = @Translation("Category Lastminute Block")
 * )
 */
class CategoryLastminuteBlock extends BlockBase{
	/**
	* {@inheritdoc}
	*/
	public function build(){
		...
		$titre = t('Last Minute');
		$urltxt = t('More last minute stays');
		...
		$query->condition('field_last_minute', 1);
