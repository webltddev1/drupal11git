...
/**
 * Category Favourites Block
 *
 * @Block(
 *   id = "catsfavourites_block",
 *   admin_label = @Translation("Category Favourites Block")
 * )
 */
class CategoryFavouritesBlock extends BlockBase{
	/**
	* {@inheritdoc}
	*/
	public function build(){
		...
		$titre = t('Our Favourites');
		$urltxt = t('More favourites');
		...
		$query->condition('field_favourite', 1);
